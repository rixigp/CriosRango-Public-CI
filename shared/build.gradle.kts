...
kotlin {
    ...
    sourceSets {
        ...
        commonTest.dependencies { implementation(kotlin("test")); implementation("io.ktor:ktor-client-mock:2.3.12"); implementation("org.jetbrains.kotlinx:kotlinx-coroutines-test:1.8.1") }
